...
//     void(sort[])(void*, size_t, size_t, int (*compar)(const void*, const void*)) = {
//         bubble_sort,
//         selection_sort,
//         insertion_sort,
//         quick_sort,
//         merge_sort
//     };
//     if (total_size >= 0 && total_size <= 10) {
//         sort[2](arr, total_size, size, CompareFn);
//     }
// }
...
//     quicksort(arr,0, arrSize-1, elemSize, compare_char);
